...
<body>
     ...
     <div class="position-relative d-flex bg-white p-0 container-xxl">
          <!-- Spinner Start -->
          <div id="spinner"
               class="top-50 position-fixed d-flex align-items-center justify-content-center bg-white w-100 translate-middle show vh-100 start-50">
                    ...
                    <div class="w-100 navbar-nav">
                         ...
                         <div class="nav-item dropdown">
                              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                        class="me-2 fa fa-laptop"></i>Management</a>
                              <div class="bg-transparent border-0 dropdown-menu">
                                   <a href="{{route('loanofficer.details.members')}}" class="dropdown-item">Add
                                        Members</a>
                              </div>
                         </div>
                         <a href="{{route('loanofficer.details.loanproduct')}}" class="nav-item nav-link"><i
                         class="me-2 fa fa-th"></i>Loan Product</a>
                         <a href="{{route('loanofficer.loan.details')}}" class="nav-item nav-link"><i
                                   class="me-2 fa fa-th"></i>Loan Pay</a>
                    </div>
               </nav>
          </div>
          <!-- Sidebar End -->
               ...
               <div class="px-4 pt-4 container-fluid">
                    ...
                    <div class="mt-4 mb-1">
                         <div class="bg-light p-4 rounded-top">
                              <div class="row">
                                   <div class="text-sm-start text-center col-12 col-sm-6">
                                        &copy; <a href="#">NEELANSHU FINANCE</a>, All Right Reserved.
                                   </div>
                                   <div class="text-sm-end text-center col-12 col-sm-6">
